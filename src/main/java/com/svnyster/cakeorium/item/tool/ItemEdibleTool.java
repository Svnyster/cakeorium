...
public class ItemEdibleTool extends ItemEdible {
    ...
    ItemEdibleTool(String name, int amount, float saturation, int duration, float attackDamageIn, float attackSpeedIn, Item.ToolMaterial materialIn, Set<Block> effectiveBlocksIn) {
        ...
        if (this instanceof ItemEdiblePickaxe) {
            toolClass = "pickaxe";
        }
        /*else if (this instanceof ItemEdibleAxe)
        {
            toolClass = "axe";
        }
        else if (this instanceof ItemEdibleSpade)
        {
            toolClass = "shovel";
        }*/
    }

    protected ItemEdibleTool(String name, int amount, float saturation, int duration, Item.ToolMaterial materialIn, Set<Block> effectiveBlocksIn) {
        this(name, amount, saturation, duration, 0.0F, 0.0F, materialIn, effectiveBlocksIn);
    }
