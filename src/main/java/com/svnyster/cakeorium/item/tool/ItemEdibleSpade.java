...
public class ItemEdibleSpade extends ItemEdibleTool implements ItemModelProvider {
    ...
    public ItemEdibleSpade(String name, int amount, float saturation, int duration, Item.ToolMaterial material)
    {
        super(name, amount, saturation, duration, 1.5F, -3.0F, material, EFFECTIVE_ON);
