...
public class ItemEdibleHoe extends ItemEdible implements ItemModelProvider {
    private final float speed;
    protected Item.ToolMaterial theToolMaterial;

    public ItemEdibleHoe(String name, int amount, float saturation, int duration, Item.ToolMaterial material)
    {
